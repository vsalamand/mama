class ListItem < ApplicationRecord
  ...
  has_one :store_section, through: :item
  ...
  after_create :create_or_copy_item
  ...
  def broadcast_create
    ...
    data = {
             ...
             store_section_name: store_section_name,
             message_partial_list_item: ApplicationController.renderer.render(partial: "list_items/show", locals: { list: self.list, list_item: self }),
  ...
  def self.add_menu_to_list(inputs_list, list)
    ...
    inputs_list.each do |input|
      ...
      list_item = ListItem.create(name: input, list: list)
