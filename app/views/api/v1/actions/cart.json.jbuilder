...
json.cart @cart.cart_items do |cart_item|
  ...
  case
    when cart_item.productable.rating == "excellent" then json.product_rating "Avis nutrition de Mama: 😋"
    when cart_item.productable.rating == "good" then json.product_rating "Avis nutrition de Mama: 🙂"
    when cart_item.productable.rating == "limit" then json.product_rating "Avis nutrition de Mama: 😕"
    when cart_item.productable.rating == "avoid" then json.product_rating "Avis nutrition de Mama: 🙁"
